...
export const ConsultationCards = () => {
  return (
    <div
      role=""
      className="relative self-start box-border caret-transparent gap-x-5 grid col-end-2 col-start-1 row-end-2 row-start-1 grid-cols-[minmax(0px,1fr)] grid-rows-[auto_auto_auto] justify-self-center max-h-[99999px] max-w-[99999px] gap-y-5 w-[81.177%] ml-0 mr-[0.00864104px] mt-0 py-5 md:gap-x-0 md:grid-cols-[1.00421fr_0.995789fr] md:grid-rows-[minmax(265.158px,max-content)_minmax(478.184px,max-content)] md:justify-self-start md:mt-[-2.0361px] md:gap-y-0 md:w-[99.5041%] md:ml-[0.5px] md:mr-0 md:py-0"
    >
