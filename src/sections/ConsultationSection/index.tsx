...
export const ConsultationSection = () => {
  return (
    <section className="relative self-stretch bg-transparent caret-transparent flex flex-col col-end-2 col-start-1 row-end-10 row-start-9 justify-self-stretch max-h-[99999px] max-w-[99999px] min-h-[900px] md:row-end-11 md:row-start-10 md:min-h-0">
