...
export const Header = () => {
  return (
    <header className="relative self-start box-border caret-transparent grid col-end-2 col-start-1 row-end-2 row-start-1 grid-cols-[1fr] grid-rows-[1fr] justify-self-stretch max-w-[99999px] pointer-events-none">
