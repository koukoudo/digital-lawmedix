...
export const ImageSection2 = () => {
  ...
  return (
    <section
      ref={sectionRef}
      className="relative self-stretch bg-transparent caret-transparent flex flex-col col-end-2 col-start-1 row-end-[20] row-start-[19] justify-self-stretch max-h-[99999px] max-w-[99999px] md:row-end-[21] md:row-start-[20]"
    >
