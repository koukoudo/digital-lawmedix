                  ...
                  <div className="box-border caret-transparent col-end-[span_5] col-start-1 row-end-[span_2] row-start-2">
                    ...
                    >
                      <div className="caret-transparent">
                              ...
                              <div className="items-center caret-transparent flex grow">
                                <div className="caret-transparent flex flex-col">
                                  <p className="text-stone-700 text-2xl caret-transparent leading-[33.6px] font-helvetica_w01_roman">
                                    How do I register my legal practice with
                                    Digital Lawmedix?
                                  </p>
                                </div>
                        ...
                        <div className="caret-transparent h-0 overflow-hidden"></div>
                          ...
                          <div className="items-start caret-transparent flex py-6">
                            <div className="caret-transparent flex w-full">
                              <div className="items-center caret-transparent flex grow">
                                <div className="caret-transparent flex flex-col">
                                  <p className="text-stone-700 text-2xl caret-transparent leading-[33.6px] font-helvetica_w01_roman">
                                    What types of medicolegal reports do you
                                    provide?
                                  </p>
                                </div>
                                <div className="items-center caret-transparent flex grow justify-end ml-3 mr-2"></div>
                          ...
                          <div className="items-start caret-transparent flex py-6">
                            <div className="caret-transparent flex w-full">
                              <div className="items-center caret-transparent flex grow">
                                <div className="caret-transparent flex flex-col">
                                  <p className="text-stone-700 text-2xl caret-transparent leading-[33.6px] font-helvetica_w01_roman">
                                    How do I upload medical records and other
                                    documents?
                                  </p>
                                </div>
                                <div className="items-center caret-transparent flex grow justify-end ml-3 mr-2"></div>
                          ...
                          <div className="items-start caret-transparent flex py-6">
                            <div className="caret-transparent flex w-full">
                              <div className="items-center caret-transparent flex grow">
                                <div className="caret-transparent flex flex-col">
                                  <p className="text-stone-700 text-2xl caret-transparent leading-[33.6px] font-helvetica_w01_roman">
                                    How can I track the progress of my
                                    medicolegal report?
                                  </p>
                                </div>
                                <div className="items-center caret-transparent flex grow justify-end ml-3 mr-2"></div>
                          ...
                          <div className="items-start caret-transparent flex py-6">
                            <div className="caret-transparent flex w-full">
                              <div className="items-center caret-transparent flex grow">
                                <div className="caret-transparent flex flex-col">
                                  <p className="text-stone-700 text-2xl caret-transparent leading-[33.6px] font-helvetica_w01_roman">
                                    What measures do you take to ensure data
                                    security?
                                  </p>
                                </div>
                                <div className="items-center caret-transparent flex grow justify-end ml-3 mr-2"></div>
