...
export const FAQSection = () => {
  return (
    <section className="relative self-stretch bg-transparent caret-transparent grid flex-col col-end-2 col-start-1 row-end-[19] row-start-[18] grid-cols-[minmax(0px,1fr)] grid-rows-[1fr] justify-self-stretch max-h-[99999px] max-w-[99999px] min-h-[871.075px] md:row-end-[20] md:row-start-[19] md:min-h-[911.26px]">
