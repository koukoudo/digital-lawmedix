...
export const AboutSection = () => {
  return (
    <section id="about" className="relative self-stretch bg-transparent caret-transparent grid flex-col col-end-2 col-start-1 row-end-13 row-start-12 grid-cols-[minmax(0px,1fr)] grid-rows-[1fr] justify-self-stretch max-h-[99999px] max-w-[99999px] min-h-[900px] md:row-end-[14] md:row-start-13 md:min-h-[1100px]">
